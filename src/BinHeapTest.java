...
class BinHeapTest {
  public static void main(String[] args) throws java.io.IOException {
	...
	BinHeap.Entry<String, Integer>[] entrys2 = new BinHeap.Entry[100];
	...
	while (true) {
	  ...
	  switch (cmd[0]) {
		case "+": // insert prio
		  ...
		  entrys2[n] = heap2.insert(cmd[1], n);
		  n++;
		  break;
		case "-": // remove entry
		...
		case "=": // changePrio entry prio
		  ...
		  break;
		case "&":
		  System.out.println(heap.contains(entrys2[Integer.parseInt(cmd[1])]));
		  break;
	  }
	}
  }
